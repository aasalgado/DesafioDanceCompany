...
//   const [discountApplied, setDiscountApplied] = useState(false); // Tracks if the discount has been applied

//   // Sync finalAmount with totalAmount whenever totalAmount changes
//   useEffect(() => {
//     setFinalAmount(totalAmount);
//   }, [totalAmount]); // This will run whenever totalAmount changes

//   // Define the available discount codes
...
//       return; // Prevent applying the discount again
//     }
...
//       // Apply the discount and update the total amount
//       setFinalAmount(finalAmount - discount);
//       setDiscountApplied(true); // Set discount as applied
...
//           options={{
//             mode: "payment",
//             amount: convertToSubcurrency(finalAmount), // Use the final amount after discount
//             currency: "usd",
//           }}
//         >
